...
const menuItems = [
  ...
  { name: "Produtos", icon: ClipboardList, href: APP_ROUTES.products.list },
    ...
    <aside className="w-64 bg-card border-r border-border flex flex-col h-screen sticky top-0 md:flex transition-colors duration-300">
      <div className="p-6">
        ...
        <button
          ...
          className="ml-5 p-2 rounded-lg text-muted-foreground hover:bg-red-500/10 hover:text-red-500 transition-colors"
        >
          <LogOut size={18} />
        </button>
      </div>
